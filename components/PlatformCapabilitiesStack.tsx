import { Radar, Filter, Route, Waypoints, BarChart3, TrendingUp } from "lucide-react";

const layers = [
  {
    icon: Radar,
    title: "Consumer Intent",
    description: "A consumer expresses demand for a specific product or service.",
  },
  {
    icon: Filter,
    title: "Qualification",
    description: "Campaign rules evaluate the inquiry against defined criteria.",
  },
  {
    icon: Route,
    title: "Routing",
  ...
  },
  {
    icon: Waypoints,
    title: "Tracking",
    description: "Every inquiry is tracked from source through outcome.",
  },
  {
    icon: BarChart3,
    title: "Analytics",
...
export default function PlatformCapabilitiesStack() {
  return (
